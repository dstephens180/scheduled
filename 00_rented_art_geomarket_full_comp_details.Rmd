...
accounts_listings_raw <- art_listing_ids_cleaned %>% 
...
# vtrips only filter
vtrips_geomarket_full_comps_details_tbl <- geomarket_full_comps_details_tbl %>%
  left_join(accounts_listings_raw, by = "id") %>%
  filter(account_id %in% c('655', '830', '1365', 
                           '1384', '1385', '1386', 
                           '1390', '1391', '1392')) %>%
  select(-account_id)
...
write_rds(vtrips_geomarket_full_comps_details_tbl, "C:\\Users\\DavidStephens\\Desktop\\Github\\artr_replica\\shiny\\vtrips_comps_full_geomarket_details_tbl.rds")
